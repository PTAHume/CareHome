    ...
    public class CareHomesController : Controller
    {
        ...
        public async Task<IActionResult> DeleteConfirmed(int Id)
        {
            ...
            AddressDetails address = await _context.AddressDetails
                ...
                .Where(s => s.CareHomes.CareHomesId == Id)
                .FirstAsync();
            ...
            List<AddressDetails> stafffAddresses = await _context.Staff
                .Include(s => s.AddressDetails)
                .Where(x => x.CareHomesId == Id)
                .Select(s => s.AddressDetails).ToListAsync();
            List<ContactDetails> staffcontacts = await _context.Staff
                .Include(s => s.ContactInfo)
                .Where(x => x.CareHomesId == Id)
            ...
            if (careHomes != null)
            {
                ...
                _context.ContactDetails.RemoveRange(staffcontacts);
                _context.AddressDetails.RemoveRange(stafffAddresses);
